...
public class DatabaseConnectionSql {
	...
	private static final String DBURL ="jdbc:sqlserver://localhost:1433;DatabaseName=StaffManageSystem" ; // 定义sqlserver数据库连接地址
	private static final String DBUSER = "sa"; // sqlserver数据库连接用户名
	private static final String PASSWORD = "lzy20001223"; // sqlserver数据库连接密码
